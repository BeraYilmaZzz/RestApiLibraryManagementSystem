...
import com.bera.yilmaz.RestAPILibaryManagementSystem.Dto.Author.AuthorSaveRequest;
import com.bera.yilmaz.RestAPILibaryManagementSystem.Dto.Author.AuthorUpdateRequest;
import com.bera.yilmaz.RestAPILibaryManagementSystem.Dto.Author.AuthorResponse;
...
public class AuthorController {
    ...
    public Author save(@RequestBody AuthorSaveRequest authorSaveRequest){
        ...
        newAuthor.setBirthYear(LocalDate.now());
    ...
    public Author update(@RequestBody AuthorUpdateRequest authorUpdateRequest){
        Author updatedAuthor = (Author) this.authorService.getById(authorUpdateRequest.getId());
        updatedAuthor.setName(authorUpdateRequest.getName());
        updatedAuthor.setBirthYear(authorUpdateRequest.getBirthday());
